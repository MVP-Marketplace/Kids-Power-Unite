      ...
      <Row className="p-3">
        ...
        <Col sm={10}>
          <Row className="p-2 align-items-center">
            ...
            <Col sm={2}>
              <Button variant="secondary" className="add-child-button">
                {" "}
                Add Child <Plus> </Plus>{" "}
              </Button>
            </Col>
          ...
          <Row>
            <Table hover>
              <thead>
                <tr>
                  <th className="recipient-details-text">Recipient Details</th>
                  <th className="recipient-details-text">Child's Nickname</th>
                  <th className="recipient-details-text">Date Gift Desired</th>
                  <th className="recipient-details-text">Priority (by date)</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td>
                    <Col>
                      <Row>
                        <b className="recipient-details-text">May 26, 2021</b>
                      </Row>
                      <Row>
                        <small className="recipient-details-text-light">
                          6:30 PM
